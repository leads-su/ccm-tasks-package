...
/**
 * Class ActionUpdatedTest
 * @package ConsulConfigManager\Tasks\Test\Unit\Events\Action
 */
class ActionUpdatedTest extends AbstractActionEventTest
{
    /**
     * @inheritDoc
     */
    protected string $activeEventHandler = ActionUpdated::class;
    ...
    {
        $this->assertInstanceOf(ActionUpdated::class, $this->createClassInstance($data));
    }
     ...
     */
    protected function createClassInstance(array $data): ActionUpdated
    {
