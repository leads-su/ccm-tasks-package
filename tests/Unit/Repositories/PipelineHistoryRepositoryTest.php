...
/**
 * Class PipelineHistoryRepositoryTest
 * @package ConsulConfigManager\Tasks\Test\Unit\Repositories
 */
class PipelineHistoryRepositoryTest extends AbstractRepositoryTest
{
    /**
     * @param array $data
     ...
     * @return PipelineHistoryRepositoryInterface
     */
    private function repository(): PipelineHistoryRepositoryInterface
    {
        return $this->app->make(PipelineHistoryRepositoryInterface::class);
    }
